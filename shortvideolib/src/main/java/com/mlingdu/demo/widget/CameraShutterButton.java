package com.mlingdu.demo.widget;
...
public class CameraShutterButton extends View {
    ...
    public CameraShutterButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CameraShutterButton(Context context, AttributeSet attrs, int defStyleAttr) {
