...
import com.mlingdu.demo.recording.video.VideoRecordingStudio.RecordingStudioStateCallback;
...
public class Videostudio {
    ...
    public void publishTimeOutFromNative() {
        if (null != recordingStudioStateCallback) {
            recordingStudioStateCallback.onRecordTimeout();
        }
    }
    ...
    public void statisticsCallbackFromNative(int connectTimeMills, int publishDurationInSec,
        ...
        if (null != recordingStudioStateCallback) {
            ...
            recordingStudioStateCallback.onRecordFinishedCallback(startTimeMills, connectTimeMills, publishDurationInSec,
