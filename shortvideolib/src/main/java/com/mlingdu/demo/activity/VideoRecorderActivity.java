...
import com.mlingdu.demo.recording.camera.preview.RecordingPreviewView;
import com.mlingdu.demo.recording.camera.preview.VideoCamera;
...
import com.mlingdu.demo.recording.video.CommonVideoRecordingStudio;
import com.mlingdu.demo.recording.video.VideoRecordingStudio;
import com.mlingdu.demo.util.FilePathUtil;
import com.mlingdu.demo.util.PermissionUtils;
import com.mlingdu.demo.widget.AlwaysMarqueeTextView;
...
public class VideoRecorderActivity extends Activity implements OnClickListener {
    ...
    private void initRecordingStudio() {
        ...
        previewScheduler = new RecordingPreviewScheduler(surfaceView, videoCamera, this) {
    ...
    private VideoRecordingStudio.RecordingStudioStateCallback recordingStudioStateCallback = new VideoRecordingStudio.RecordingStudioStateCallback() {
        ...
        public void onStartRecordFailed() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(VideoRecorderActivity.this, "访问文件失败", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        @Override
        public void onRecordFinishedCallback(long startTimeMills, int connectTimeMills, int publishDurationInSec,
                                             float discardFrameRatio, float publishAVGBitRate, float expectedBitRate, String adaptiveBitrateChart) {
            StringBuilder statisticsBuilder = new StringBuilder("onRecordFinishedCallback : ");
            ...
            statisticsBuilder.append("durationInSec【").append(publishDurationInSec).append("】");
...
//		startActivity(intent);
    ...
    public void onClick(View v) {
        ...
        }else if (id == R.id.song_selection) {
